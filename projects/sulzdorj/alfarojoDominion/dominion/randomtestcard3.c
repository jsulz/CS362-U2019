...
void printResults( int failures, struct checker *infoH ){
    ...
    printf( "In %d iterations of playing the tribute card, the number of actions were incorrect\n", infoH->numActionCheck );
    printf( "In %d iterations of playing the tribute card, the number of coins were incorrect\n", infoH->numCoinCheck );
    printf( "In %d iterations of playing the tribute card, the number of buys were incorrect\n", infoH->numBuysCheck );
    printf( "In %d iterations of playing the tribute card, the played cards were incorrect\n", infoH->numPlayedCardCountCheck );
    printf( "In %d iterations of playing the tribute card, the supply cards were incorrect\n", infoH->supplyCardCheck );
    printf( "In %d iterations of playing the tribute card, the players deck count were incorrect\n", infoH->deckCountCheck );
    printf( "In %d iterations of playing the tribute card, the players discard counts were incorrect\n", infoH->discardCountCheck );
    printf( "In %d iterations of playing the tribute card, the players discard piles were incorrect\n", infoH->discardCheck );
    printf( "In %d iterations of playing the tribute card, the players hands counts were incorrect\n", infoH->handCountCheck );
